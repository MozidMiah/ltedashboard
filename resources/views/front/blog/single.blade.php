                    ...
                    <div class="main-content">
                        <div class="row grid cols-sm-2"
                            ...
                            <article class="post post-masonry grid-item overlay-zoom fashion">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/2cols/1.jpg') }}" width="600" height="420"
                                            alt="blog">
                                    </a>
                                </figure>
                                <div class="post-details">
                                    ...
                                    <div class="post-content">
                                        <p>Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo,
                                            ...
                                            href="{{ route('blog.single') }}" class="btn btn-link btn-primary">(read more)</a>
                                    </div>
                                    <div class="post-meta">
                            ...
                            <article class="post post-masonry grid-item overlay-zoom others technology">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/classic/2.jpg') }}" width="930" height="500"
                                            alt="blog">
                                    </a>
                                </figure>
                                <div class="post-details">
                            ...
                            <article class="post post-masonry grid-item overlay-zoom clothes">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/classic/3.jpg') }}" width="930" height="500"
                                            alt="blog">
                                    </a>
                                </figure>
                                <div class="post-details">
                            ...
                            <article class="post post-masonry grid-item overlay-zoom lifestyle">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/2cols/4.jpg') }}" width="600" height="420"
                                            alt="blog">
                                    </a>
                                </figure>
                                <div class="post-details">
                            ...
                            <article class="post post-masonry grid-item overlay-zoom entertainment lifestyle shoes others">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/2cols/5.jpg') }}" width="600" height="420"
                                            alt="blog">
                                    </a>
                                </figure>
                                <div class="post-details">
                            ...
                            <article class="post post-masonry grid-item overlay-zoom fashion lifestyle">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/classic/6.jpg') }}" width="930" height="500"
                                            alt="blog">
                                    </a>
                                </figure>
                                <div class="post-details">
                                        ...
                                        <div class="owl-carousel owl-theme owl-nav-top row cols-1"
                                            ...
                                            <div class="widget-col">
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/1.jpg') }}" alt="150"
                                                            height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/2.jpg') }}" alt="150"
                                                            height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-2">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/3.jpg') }}" alt="150"
                                                            height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                            ...
                                            <div class="widget-col">
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/4.jpg') }}" alt="150"
                                                            height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/5.jpg') }}" alt="150"
                                                            height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-2">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/6.jpg') }}" alt="150"
                                                            height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
