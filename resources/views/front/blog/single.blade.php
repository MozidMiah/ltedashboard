                    ...
                    <div class="main-content post-single-content">
                        <div class="post post-grid post-single">
                            <figure class="post-media br-sm">
                                <img src="{{ asset('front/assets/images/blog/single/1.jpg') }}" alt="Blog" width="930" height="500" />
                            </figure>
                            <div class="post-details">
                                <div class="post-meta">
                                    by <a href="{{ route('blog.single') }}" class="post-author">John Doe</a>
                                    - <a href="{{ route('blog.single') }}" class="post-date">03.01.2021</a>
                                    <a href="{{ route('blog.single') }}" class="post-comment"><i
                                            class="w-icon-comments"></i><span>0</span>Comments</a>
                                </div>
                                <h2 class="post-title"><a href="{{ route('blog.single') }}">Fashion tells about who you are from external
                                        point</a></h2>
                                <div class="post-content">
                                    <p>Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget
                                        blandit nunc tortor eu nibh. Suspendisse potenti.
                                        Sed egstas, ant at vulputate volutpat, uctus metus libero eu augue, vitae luctus
                                    ...
                                    <p>Morbi purus libero, faucibus adi piscing, com modo quis, gravida iest.
                                        ...
                                        dapibus eu, fermen tum et, dapibus sed, urna. <a href="{{ route('blog.single') }}">Morbi interdum
                                            mollis sapien.</a>
                        ...
                        <!-- End Blockquote -->
                        <p class="mb-10">Morbi interdum mollis sapien. Sed ac risus. Pha sellus lacinia, magna a laoreet,
                            lect us arcu pulvinar risus, vitae fac ilisis libeo dolor.
                            Sed vel lacus. Mauris nibh felis, adipiscing varius, adipiscing in, lacinia vel, tellus.
                            Suspendisse ac urna.</p>
                        <h4 class="title title-md font-weight-bold">Defaulting to Mindfulness: The Third Person Effect</h4>
                        <p class="mb-2">Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet
                            vel,
                        ...
                        <p>Nibh ipsum consequat nisl vel. Non arcu risus quis varius quam quisque id diam vel. Eu turpis
                            egestas pharetra.</p>
                        <div class="tags">
                        ...
                        <div class="post-author-detail">
                            <figure class="author-media mr-4">
                                <img src="{{ asset('front/assets/images/blog/single/1.png') }}" alt="Author" width="105" height="105" />
                            </figure>
                            <div class="author-details">
                                <div class="author-name-wrapper flex-wrap mb-2">
                                    ...
                                    <a href="{{ route('blog.single') }}"
                                        class="btn btn-primary btn-link btn-icon-right pb-0 text-normal font-weight-normal mb-2">More
                                        Posts by admin<i class="w-icon-long-arrow-right"></i></a>
                                </div>
                                <p class="mb-0">Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismoder eu
                                    pulvinar nunc sapien ornare nisl.
                                    Ped earcudaap ibuseu, fermentum et, dapibus sed, urna. Morbi interdum mollis sapien.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="post-navigation">
                            <div class="nav nav-prev">
                                <a href="{{ route('blog.single') }}" class="align-items-start text-left">
                            ...
                            <div class="nav nav-next">
                                <a href="{{ route('blog.single') }}" class="align-items-end text-right">
                        ...
                        <div class="post-slider owl-carousel owl-theme owl-nav-top row cols-lg-3 cols-md-4 cols-sm-3 cols-xs-2 cols-1 pb-2"
                            ...
                            <div class="post post-grid">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/single/2.jpg') }}" alt="Post" width="296"
                                ...
                                <div class="post-details text-center">
                                    ...
                                    <h4 class="post-title mb-3"><a href="{{ route('blog.single') }}">Fashion tell about who you are
                                            from...</a></h4>
                                    <a href="{{ route('blog.single') }}"
                            ...
                            <div class="post post-grid">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/single/3.jpg') }}" alt="Post" width="296"
                                            height="190" style="background-color: #cad2d1;" />
                                    </a>
                                </figure>
                                <div class="post-details text-center">
                                    <div class="post-meta">
                                        by <a href="{{ route('blog.single') }}" class="post-author">Hilary Kreton</a>
                                        - <a href="{{ route('blog.single') }}" class="post-date">03.05.2021</a>
                                    </div>
                                    <h4 class="post-title mb-3"><a href="{{ route('blog.single') }}">Comes a cool blog post with
                                            Images</a></h4>
                                    <a href="{{ route('blog.single') }}"
                                        class="btn btn-link btn-dark btn-underline font-weight-normal">Read More<i
                                            class="w-icon-long-arrow-right"></i></a>
                            ...
                            <div class="post post-grid">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/single/4.jpg') }}" alt="Post" width="296"
                                            height="190" style="background-color: #ececec;" />
                                    </a>
                                </figure>
                                <div class="post-details text-center">
                                    <div class="post-meta">
                                        by <a href="{{ route('blog.single') }}" class="post-author">Casper Dailn</a>
                                        - <a href="{{ route('blog.single') }}" class="post-date">03.05.2021</a>
                                    </div>
                                    <h4 class="post-title mb-3"><a href="{{ route('blog.single') }}">Comes a cool blog post with
                                            Images</a></h4>
                            ...
                            <div class="post post-grid">
                                <figure class="post-media br-sm">
                                    <a href="{{ route('blog.single') }}">
                                        <img src="{{ asset('front/assets/images/blog/single/5.jpg') }}" alt="Post" width="296"
                                ...
                                <div class="post-details text-center">
                                    ...
                                    <h4 class="post-title mb-3"><a href="{{ route('blog.single') }}">We want to be different and
                        ...
                        <ul class="comments list-style-none pl-0">
                            <li class="comment">
                                <div class="comment-body">
                                    <figure class="comment-avatar">
                                        <img src="{{ asset('front/assets/images/blog/single/1.png') }}" alt="Avatar" width="90"
                                            height="90" />
                                    </figure>
                                    <div class="comment-content">
                                        ...
                                        <p>Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar
                                            nunc sapien ornare nisl.arcu fer
                                            ment umet, dapibus sed, urna.</p>
                                        <a href="#"
                                            class="btn btn-dark btn-link btn-underline btn-icon-right btn-reply">Reply<i
                                                class="w-icon-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            </li>
                            <li class="comment">
                                <div class="comment-body">
                                    <figure class="comment-avatar">
                                        <img src="{{ asset('front/assets/images/blog/single/2.png') }}" alt="Avatar" width="90"
                                            height="90" />
                                    </figure>
                                    <div class="comment-content">
                                        <h4 class="comment-author font-weight-bold">
                        ...
                        <form class="reply-section pb-4">
                            ...
                            <button class="btn btn-dark btn-rounded btn-icon-right btn-comment">Post Comment<i
                        ...
                        <div class="sidebar-content">
                            <div class="sticky-sidebar">
                                ...
                                <div class="widget widget-posts">
                                    ...
                                    <div class="widget-body">
                                        <div class="owl-carousel owl-theme owl-nav-top row cols-1"
                                            data-owl-options="{
                                                'nav': true,
                                                'dots': false,
                                                'margin': 20
                                            ...
                                            <div class="widget-col">
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/1.jpg') }}" alt="Blog"
                                                ...
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/2.jpg') }}" alt="Blog"
                                                            width="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-2">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/3.jpg') }}" alt="Blog"
                                                            width="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                            ...
                                            <div class="widget-col">
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/4.jpg') }}" alt="Blog"
                                                            width="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/5.jpg') }}" alt="Blog"
                                                            width="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-2">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/6.jpg') }}" alt="Blog"
                                                            width="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
