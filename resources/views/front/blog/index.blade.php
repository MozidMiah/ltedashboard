                                        ...
                                        <div class="owl-carousel owl-theme owl-nav-top row cols-1"
                                            ...
                                            <div class="widget-col">
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/1.jpg') }}"
                                                            alt="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/2.jpg') }}"
                                                            alt="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-2">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/3.jpg') }}"
                                                            alt="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                            ...
                                            <div class="widget-col">
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/4.jpg') }}"
                                                            alt="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-4">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/5.jpg') }}"
                                                            alt="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
                                                ...
                                                <div class="post-widget mb-2">
                                                    <figure class="post-media br-sm">
                                                        <img src="{{ asset('front/assets/images/blog/sidebar/6.jpg') }}"
                                                            alt="150" height="150" />
                                                    </figure>
                                                    <div class="post-details">
                                                        <div class="post-meta">
