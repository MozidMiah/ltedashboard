                        ...
                        <div class="tab-pane" id="sign-up">
                            ...
                            <div class="checkbox-content login-vendor">
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <small>https://www.portotheme.com/wordpress/wolmart/demo-1/store/</small>
                                </div>
                                <div class="form-group mb-5">
                            ...
                            <div class="form-checkbox user-checkbox mt-0">
                                <input type="checkbox" class="custom-checkbox checkbox-round active" id="check-customer"
                                    name="check-customer" required="">
