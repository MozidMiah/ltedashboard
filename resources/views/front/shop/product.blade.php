            ...
            <ul class="product-nav list-style-none">
                <li class="product-nav-prev">
                    ...
                    <span class="product-nav-popup">
                        <img src="{{ asset('front/assets/images/products/product-nav-prev.jpg') }}" alt="Product"
                ...
                <li class="product-nav-next">
                    ...
                    <span class="product-nav-popup">
                        <img src="{{ asset('front/assets/images/products/product-nav-next.jpg') }}" alt="Product"
                            width="110" height="110" />
                                ...
                                <div class="product-gallery product-gallery-sticky">
                                    <div
                                        ...
                                        <figure class="product-image">
                                            <img src="{{ asset('front/assets/images/products/default/1-800x900.jpg') }}"
                                                data-zoom-image="{{ asset('front/assets/images/products/default/1-800x900.jpg') }}"
                                                alt="Electronics Black Wrist Watch" width="800" height="900">
                                        </figure>
                                        <figure class="product-image">
                                            <img src="{{ asset('front/assets/images/products/default/2-800x900.jpg') }}"
                                                data-zoom-image="{{ asset('front/assets/images/products/default/2-800x900.jpg') }}"
                                                alt="Electronics Black Wrist Watch" width="488" height="549">
                                        </figure>
                                        <figure class="product-image">
                                            <img src="{{ asset('front/assets/images/products/default/3-800x900.jpg') }}"
                                                data-zoom-image="{{ asset('front/assets/images/products/default/3-800x900.jpg') }}"
                                                alt="Electronics Black Wrist Watch" width="800" height="900">
                                        </figure>
                                        <figure class="product-image">
                                            <img src="{{ asset('front/assets/images/products/default/4-800x900.jpg') }}"
                                                data-zoom-image="{{ asset('front/assets/images/products/default/4-800x900.jpg') }}"
                                                alt="Electronics Black Wrist Watch" width="800" height="900">
                                        </figure>
                                        <figure class="product-image">
                                            <img src="{{ asset('front/assets/images/products/default/5-800x900.jpg') }}"
                                                data-zoom-image="{{ asset('front/assets/images/products/default/5-800x900.jpg') }}"
                                                alt="Electronics Black Wrist Watch" width="800" height="900">
                                        </figure>
                                        <figure class="product-image">
                                            <img src="{{ asset('front/assets/images/products/default/6-800x900.jpg') }}"
                                                data-zoom-image="{{ asset('front/assets/images/products/default/6-800x900.jpg') }}"
                                                alt="Electronics Black Wrist Watch" width="800" height="900">
                                        </figure>
                                    </div>
                                    <div class="product-thumbs-wrap">
                                        <div class="product-thumbs row cols-4 gutter-sm">
                                            <div class="product-thumb active">
                                                <img src="{{ asset('front/assets/images/products/default/1-800x900.jpg') }}" alt="Product Thumb"
                                                    width="800" height="900">
                                            </div>
                                            <div class="product-thumb">
                                                <img src="{{ asset('front/assets/images/products/default/2-800x900.jpg') }}" alt="Product Thumb"
                                                    width="800" height="900">
                                            </div>
                                            <div class="product-thumb">
                                                <img src="{{ asset('front/assets/images/products/default/3-800x900.jpg') }}" alt="Product Thumb"
                                                    width="800" height="900">
                                            </div>
                                            <div class="product-thumb">
                                                <img src="{{ asset('front/assets/images/products/default/4-800x900.jpg') }}" alt="Product Thumb"
                                                    width="800" height="900">
                                            </div>
                                            <div class="product-thumb">
                                                <img src="{{ asset('front/assets/images/products/default/5-800x900.jpg') }}" alt="Product Thumb"
                                                    width="800" height="900">
                                            </div>
                                            <div class="product-thumb">
                                                <img src="{{ asset('front/assets/images/products/default/6-800x900.jpg') }}" alt="Product Thumb"
                                                    width="800" height="900">
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 mb-4 mb-md-6">
                                <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                    ...
                                    <div class="product-bm-wrapper">
                                        <figure class="brand">
                                            <img src="{{ asset('front/assets/images/products/brand/brand-1.jpg') }}" alt="Brand"
                                                width="102" height="48" />
                                        </figure>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6 mb-4">
                                            <figure class="vendor-banner br-sm">
                                                <img src="{{ asset('front/assets/images/products/vendor-banner.jpg') }}" alt="Vendor Banner"
