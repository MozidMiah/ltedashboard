        ...
        <div class="page-content mb-10">
            ...
            <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6"
                ...
                <div class="container banner-content">
                    ...
                    <a href="{{ route('shop.index') }}" class="btn btn-dark btn-rounded btn-icon-right">Discover Now<i
                    ...
                    <div class="main-content">
                        <nav class="toolbox sticky-toolbox sticky-content fix-top">
                            ...
                            <div class="toolbox-right">
                                ...
                                <div class="toolbox-item toolbox-layout">
                                    <a href="{{ route('shop.index') }}" class="icon-mode-grid btn-layout">
                        ...
                        <div class="product-wrapper row cols-xl-2 cols-sm-1 cols-xs-2 cols-1">
                            <div class="product product-list product-select">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="product-action">
                                        <a href="{{ route('shop.product') }}" class="btn-product btn-cart"
                            ...
                            <div class="product product-list">
                                <figure class="product-media">
                                    <a href="{{ route('shop.product') }}">
                                        <img src="{{ asset('front/assets/images/shop/2-1.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                        <img src="{{ asset('front/assets/images/shop/2-2.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-quickview w-icon-search"
                            ...
                            <div class="product product-list">
                                <figure class="product-media">
                                    <a href="{{ route('shop.product') }}">
                                        <img src="{{ asset('front/assets/images/shop/3.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-quickview w-icon-search"
                            ...
                            <div class="product product-list">
                                <figure class="product-media">
                                    <a href="{{ route('shop.product') }}">
                                        <img src="{{ asset('front/assets/images/shop/4.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-quickview w-icon-search"
                            ...
                            <div class="product product-list">
                                <figure class="product-media">
                                    <a href="{{ route('shop.product') }}">
                                        <img src="{{ asset('front/assets/images/shop/5.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-quickview w-icon-search"
                            ...
                            <div class="product product-list">
                                <figure class="product-media">
                                    <a href="{{ route('shop.product') }}">
                                        <img src="{{ asset('front/assets/images/shop/6.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-quickview w-icon-search"
                                ...
                                <figure class="product-media">
                                    <a href="{{ route('shop.product') }}">
                                        <img src="{{ asset('front/assets/images/shop/7-1.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                        <img src="{{ asset('front/assets/images/shop/7-2.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-quickview w-icon-search"
                            ...
                            <div class="product product-list">
                                <figure class="product-media">
                                    <a href="{{ route('shop.product') }}">
                                        <img src="{{ asset('front/assets/images/shop/8.jpg') }}" alt="Product"
                                            width="330" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-quickview w-icon-search"
