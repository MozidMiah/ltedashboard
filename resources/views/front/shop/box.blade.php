                    ...
                    <div class="main-content">
                        <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6 br-xs"
                            ...
                            <div class="banner-content">
                                ...
                                <a href="{{ route('shop.index') }}" class="btn btn-dark btn-rounded btn-icon-right">Discover
                        ...
                        <nav class="toolbox sticky-toolbox sticky-content fix-top">
                            ...
                            <div class="toolbox-right">
                                ...
                                <div class="toolbox-item toolbox-layout">
                                    <a href="{{ route('shop.box') }}" class="icon-mode-grid btn-layout active">
                                ...
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="ratings-container">
                                            ...
                                            <a href="https://www.portotheme.com/html/wolmart/product.html"
                                                class="rating-reviews">(10 reviews)</a>
                                        </div>
                                        <div class="product-pa-wrapper">
                                            <div class="product-price">
                                ...
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="ratings-container">
                                            ...
                                            <a href="https://www.portotheme.com/html/wolmart/product.html"
                                                class="rating-reviews">(7 reviews)</a>
                                        </div>
                                        <div class="product-pa-wrapper">
                                            <div class="product-price">
                                                $15.00
                                ...
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="ratings-container">
                                            ...
                                            <a href="https://www.portotheme.com/html/wolmart/product.html"
                                                class="rating-reviews">(12 reviews)</a>
                                        </div>
                                        <div class="product-pa-wrapper">
                                            <div class="product-price">
                                                $374.00
